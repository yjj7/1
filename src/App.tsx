...
export default function App() {
  ...
  useEffect(() => {
    const data: Record<string, any> = { swm_scene: selectedSceneId, swm_music: selectedMusicId, swm_musicVol: musicVolume, swm_bgVol: bgVolume, swm_duration: timerDuration, swm_tasks: tasks, swm_pomodoros: pomodoroCount, swm_dailyGoal: dailyGoal, swm_history: studyHistory, swm_notes: notes, swm_streak: streak, swm_presets: scenePresets, swm_weekplan: weekPlan, swm_achievements: earnedAchievements };
